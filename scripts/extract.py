...
import networkx as nx  # library for graph construction
# import matplotlib.pyplot as plt
from javalang import tokenizer  # library for parsing Java source code
...
def extract_keywords(file_path):
    ...
    try:
        ...
        with open('./failed/keywords.txt', 'a+') as failed_file:
        ...
        if os.path.isfile(file_path):
            ...
            if keywords_dict:
                for keyword in keywords_dict:
                    G.add_edge(file, keyword, weight=keywords_dict[keyword])
    return G
