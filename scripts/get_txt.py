...
csv_files = [
    DATA_PROCESSED_DIR / 'BCB' / 'Clone-pairs-MT3.csv',
    DATA_PROCESSED_DIR / 'BCB' / 'Clone-pairs-ST3.csv',
    DATA_PROCESSED_DIR / 'BCB' / 'Clone-pairs-T1.csv',
    DATA_PROCESSED_DIR / 'BCB' / 'Clone-pairs-T2.csv',
    DATA_PROCESSED_DIR / 'BCB' / 'Clone-pairs-T4.csv',
    DATA_PROCESSED_DIR / 'BCB' / 'Clone-pairs-VST3.csv',
    DATA_PROCESSED_DIR / 'BCB' / 'NoClone-pairs.csv'
]
...
# save_data_to_csv(train_data, DATA_PROCESSED_DIR / 'split_data' / 'train.csv')
# save_data_to_csv(test_data, DATA_PROCESSED_DIR / 'split_data' / 'test.csv')
# save_data_to_csv(val_data, DATA_PROCESSED_DIR / 'split_data' / 'val.csv')
save_data_to_csv(selected_data, DATA_PROCESSED_DIR / 'split_data' / 'all.csv')
