...
def save_concatenated_vectors_1(csv_file, output_dir, w):
    ...
    df = pd.read_csv(DATA_PROCESSED_DIR / 'BCB' / csv_file)
    if len(df) > 250000:
...
if __name__ == '__main__':
    ...
    # scalability
    w = ProNE.load(str(GENERATED_DIR / 'scalability_embed' / 'dim_16' / '1000000' / 'embedding_1.zip'))
    output_dir = str(GENERATED_DIR / 'scalability_embed' / 'dim_16' / '1000000' / 'fcl_sca')
