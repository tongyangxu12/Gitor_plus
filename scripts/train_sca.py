...
if __name__ == '__main__':
    ...
    # Create graph
    loc_path = str(DATA_PROCESSED_DIR / 'filtered_code_files')
    ...
    with open(os.path.join(str(output_dir), 'train_time.txt'), 'a+') as ff:
        ff.write(f'gaijin_train_time: {train_time}s    num: {args.num}\n')

    g2v_1.save(os.path.join(str(output_dir), f"embedding_{args.num}"))
